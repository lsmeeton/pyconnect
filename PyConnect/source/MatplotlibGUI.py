...
#        lines = LineCollection(self.plot_list)#,
#                               linewidth = 0.2,
                               #color=self.colour_list)
        
#        lines.set_array(self.disc.map.get_array())
#        self.ax.plot(self.plot_listx,self.plot_listz, c=self.colour_list, linewidth=0.2)
...
#        self.plot_list.append([(x1,z1),(x2,z2)])
#        self.plot_list.append([(x1,z1),(x2,z2)])
#        self.plot_list.append(None)
#        self.plot_listx.extend([x1,x2])
#        self.plot_listx.append(None)
#        self.plot_listz.extend([z1,z2])
#        self.plot_listz.append(None)
#        self.colour_list.extend(rgb)
...
#        self.ax = self.fig.add_subplot(122, projection='3d')
#        
#        self.ax.set_title('Disconnectivity Graph')
#        self.ax.set_title('Metric Disconnectivity Graph')
#        
...
#            self.plot_dataMDG = self.ax.plot([x1,x2],[y1,y2],[z1,z2], color =rgb, alpha = 0.75,
#                                                linewidth=0.2)
#    
#    def on_save_plot(self, event):
#        file_choices = "PS (*.ps)|*.ps"
...
#    DG = DGCanvasFrame(disc).init_plot()
#    DG.savefig("tree.eps", formate="eps")
    app = wx.PySimpleApp()
